...
----------------------------------------------------------------------
    ...
    ./lib/Data/ppport.h -- Perl/Pollution/Portability Version 3.20
    ...
    Use 'perldoc ./lib/Data/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl ./lib/Data/ppport.h [options] [source files]
...
This version of F<./lib/Data/ppport.h> is designed to support operation with Perl
...
Display the version of F<./lib/Data/ppport.h>.
...
Tell F<./lib/Data/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<./lib/Data/ppport.h> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<./lib/Data/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<./lib/Data/ppport.h> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<./lib/Data/ppport.h>.
This reduces the size of F<./lib/Data/ppport.h> dramatically and may be useful
if you want to include F<./lib/Data/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<./lib/Data/ppport.h> will have a C<--unstrip> option that allows
...
F<./lib/Data/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<./lib/Data/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl ./lib/Data/ppport.h --list-provided

to see which API elements are provided by ./lib/Data/ppport.h.
...
also deprecated. You can safely use the supported API, as F<./lib/Data/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<./lib/Data/ppport.h>.
...
macro. Just C<#define> the macro before including C<./lib/Data/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "./lib/Data/ppport.h"
...
F<./lib/Data/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<./lib/Data/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<./lib/Data/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl ./lib/Data/ppport.h
...
use something like this:
    ...
    perl ./lib/Data/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl ./lib/Data/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl ./lib/Data/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl ./lib/Data/ppport.h --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl ./lib/Data/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl ./lib/Data/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl ./lib/Data/ppport.h --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<./lib/Data/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<./lib/Data/ppport.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error ./lib/Data/ppport.h only works with Perl version 5
 ...
 * 5.005 perls, you can use aTHXR (supplied by ./lib/Data/ppport.h), which will
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, ./lib/Data/ppport.h implements a version
